    ...
    public void Search(View v){
        ...
        if(edParticipant.getText().length()!=0 || edDate.getText().length() !=0 ||
            ...
            if (edParticipant.getText().length() != 0) {
                res = dbAdapter.getMeeting(edParticipant.getText().toString());
            }
            if (edDate.getText().length() != 0) {
                ArrayList<Meeting> temp = dbAdapter.getMeetingDate(edDate.getText().toString());
                for (Meeting m: temp) {
                    res.add(m);
                }
            }
            if (edTime.getText().length() != 0) {
                ArrayList<Meeting> temp = dbAdapter.getMeetingDate(edTime.getText().toString());
                for (Meeting m: temp) {
                    res.add(m);
                }
            }
